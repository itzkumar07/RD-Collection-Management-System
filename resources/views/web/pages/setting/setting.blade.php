...
@section('panel-header')
    <div>
        <ul class="breadcrumb">
            ...
            <li><a href="{{route('web.view.setting')}}">Settings</a></li>
        </ul>
    ...
    <figure class="panel-card">
        <div class="panel-card-body">
            <div class="space-y-3">
                ...
                <div>
                    <a href="{{route('web.view.setting.account')}}" class="link text-sm flex items-center space-x-2">
    ...
    <figure class="panel-card">
        <div class="panel-card-body">
            <div class="space-y-3">
                ...
                <div>
                    <a href="{{route('web.view.setting.password')}}" class="link text-sm flex items-center space-x-2">
