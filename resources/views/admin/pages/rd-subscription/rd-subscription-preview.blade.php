...
@section('panel-header')
    <div>
        <ul class="breadcrumb">
            <li><a href="{{ route('admin.view.dashboard') }}">User</a></li>
            <li><i data-feather="chevron-right"></i></li>
            <li><a href="{{ route('admin.view.rdsubscription.list') }}">RD Subscriptions</a></li>
            <li><i data-feather="chevron-right"></i></li>
            <li><a href="{{ route('admin.view.rdsubscription.preview', ['id' => $rd_subscription->id]) }}">RD Subscription
                    Details</a></li>
        </ul>
...
@section('panel-body')
    <figure class="panel-card">
        ...
        <div class="panel-card-footer">
            <a href="{{ route('admin.handle.rdsubscription.recipt.download', ['id' => $rd_subscription->id]) }}" class="btn-primary-sm w-fit">
                Download Recipt
            </a>
        </div>
    </figure>
